...
> **Source:** <https://learn.microsoft.com/en-us/azure/confidential-computing/use-cases-scenarios>

*Understand how to use confidential computing in your scenario.*
...
The adoption of hardware security modules (HSMs) like [Azure Key Vault Managed HSM](/en-us/azure/key-vault/managed-hsm/overview) enables secure transfer of keys and certificates to protected cloud storage. With an HSM, the cloud service provider isn't allowed to access such sensitive information.

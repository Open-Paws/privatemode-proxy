...
> **Source:** <https://learn.microsoft.com/en-us/azure/confidential-computing/enclave-aware-containers>

*enclave ready application containers support on Azure Kubernetes Service (AKS)*
...
[Azure Attestation](/en-us/azure/attestation/overview)

[Intel SGX Confidential Virtual Machine on Azure](virtual-machine-solutions-sgx)
